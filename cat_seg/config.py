...
def add_cat_seg_config(cfg):
    ...
    cfg.EVALUATION = CN()
    cfg.EVALUATION.USE_STRUCTURED_MEASURE = True # Add: Use HS_OSM evaluation
    cfg.EVALUATION.S_ALPHA = 0.5 # Add: Weight parameter in S-measure
    cfg.EVALUATION.PRECOMPUTED_MATRIX_PATH = ""
    cfg.EVALUATION.HIERARCHY_GAMMA = 0.3
    cfg.EVALUATION.HIERARCHY_BETA = 0.5
    cfg.EVALUATION.HIERARCHY_DELTA = 4
    cfg.EVALUATION.HIERARCHY_ALPHA = 0.4
    cfg.EVALUATION.USE_WHICH_ADJ = 0
    cfg.EVALUATION.SOFT_S_TOP_K = 3
    cfg.EVALUATION.GLOVE_PATH = "/home/hongchang/SED/SED-main/SS_mIoU/glove.840B.300d.txt"
    cfg.EVALUATION.GLOVE_MAPPING_FILE = "SS_mIoU/word_missing/pc459_glove_mappings.json"  # Add: GloVe vocabulary mapping file path
    cfg.EVALUATION.WORDNET_MAPPING_FILE = "SS_mIoU/word_missing/pc459_wordnet_mappings1.json"  # Add: WordNet vocabulary mapping file path
    cfg.EVALUATION.PRECOMPUTED_MATRIX_PATH = "similarity_matrix_all/similarity_matrix_d4/ade150_similarity_matrix.csv"  # Add: Precomputed similarity matrix path